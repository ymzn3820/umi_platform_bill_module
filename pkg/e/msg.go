...
var MsgFlags = map[int]string{
	...
	ERROR_GET_PRODUCT_BY_ID:         "未找到对应产品",
	ERROR_CONVERT_PARAM:             "参数转换异常",
	ERROR_ADD_HASHRATE:              "添加算力值异常",
	ERROR_CONSUME_HASHRATE:          "消耗算力值异常",
	ERROR_GET_HASHRATES:             "获取用户算力值失败",
	ERROR_RENEW_HASHRATES:           "更新算力值异常",
	ERROR_CHECK_HASHRATE:            "检查算力值异常",
	ERROR_SELECT_DB:                 "切换数据库异常",
	ERROR_START_MULTI:               "开启事务异常",
	INSUFFICIENT_HASHRATE:           "您的算力值不足，请充值后再试",
}
